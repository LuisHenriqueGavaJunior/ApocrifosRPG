    ...
    <div className="Conceitos">
     <div className='ConteudoConceitos'>
      ...
      <section className='Espiritos'>
        ...
        Seres feitos puramente de mana vindos do centro do mundo. Os espíritos são divididos em 4 categorias: Espíritos Menores, Espíritos Maiores, Espíritos Artificiais e Grandes Espíritos.

        <h3 className='Conceitoespiritossubtitulos'>Espíritos menores:</h3>
        ...
        <h3 className='Conceitoespiritossubtitulos'>Espíritos maiores:</h3>
        ...
        <h3 className='Conceitoespiritossubtitulos'>Grandes Espíritos:</h3>
        ...
        <h3 className='Conceitoespiritossubtitulos'>Espíritos artificiais:</h3>
      ...
      <section className='Contratos'>
        <h2 className='Conceitocontratos'>Contratos:</h2>
        ...
        <h3 className='Conceitocontratossubtitulos'>Exemplo de Contrato 1:</h3> Um troll realiza um Contrato com um gnomo, onde as condições são do troll proteger o gnomo da melhor forma possível, e caso o Contrato seja descumprido o troll queimará.
